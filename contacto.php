...
<meta name="theme-color" content="#ffffff">
  ...
  <?php require "components/navbar.php"; ?>
      ...
      <div class="container">
        ...
        <div class="row" style="place-content: center;" >
          <ul class="list-unstyled mb-0" style="text-align-last: center;padding-bottom: 10px;padding-top: 10px;">
              <li><a href="https://wa.me/+5491163009632"><img src="images/whatsapp-solid.svg" style="width:50px" align="middle" alt="Phone"></li>
              <li align="center">Contactanos</li></a>
          </div>
          <div class="row" style="place-content: center;" >
            <ul class="list-unstyled mb-0" style="text-align-last: center;padding-bottom: 10px;padding-top: 10px;">
              <li><a href="mailto:jmpozzo15@gmail.com"><img src="images/email-solid.svg" style="width:50px" align="middle" alt="Mail"></li>
              <li>Escribinos</li></a>
          </div>
    </div>
