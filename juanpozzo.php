...
<meta name="theme-color" content="#ffffff">
    ...
    <title>JMP OSTEOPATIA</title>
    <!-- SEO -->
    <meta name="Description" content="Centro Médico especializado en Medicina y Rehabilitación Deportiva. Múltiples Servicios de Diagnóstico y Tratamiento">
  </head>
  <body>
                ...
                <div class="row align-items-center flex-row-reverse">
                    <div class="col-lg-6">
                        <div class="about-text go-to">
                            <h1 class="dark-color">Acerca de mí</h1>
                            <h6 class="theme-color lead text-uppercase">Juan Manuel Pozzo</h6>
                            <p>Soy un <mark> osteópata y kinesiólogo </mark> que se ha desempeñado en varios clubes del futbol argentino logrando importantes resultados en la recuperación de deportistas del más alto nivel. Tras dicha labor, he decidido llevar mi experiencia a un campo masivo donde toda persona tenga la posibilidad de recuperarse de cualquier tipo de lesión.</p>
                            <h6 class="theme-color lead">ESTUDIOS REALIZADOS</h6>
                            <div class="row about-list">
                                <div class="col-12">
                                    <div class="media">
                                    <p> - Máster en Técnicas Osteopáticas EOM</p>
                                    </div>
                                    <div class="media">
                                        <p> - Licenciado en Terapia Física, Universidad del Salvador</p>
                                    </div>
                                    <div class="media">
                                        <p> - Terapista Físico, Universidad del Salvador</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="about-avatar">
                            <img src="images/jmpozzo.png" title="" alt="Juan Manuel Pozzo Profile">
                        </div>
                    </div>
                </div>
            </div>
