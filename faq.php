	  ...
	  <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
        ...
        ¿Qué es la Osteopatía?
		  ...
		  <div id="collapse0" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading0">
			<div class="panel-body px-3 mb-4">
			  <p>La Osteopatía es la medicina tradicional alternativa que se encarga de tratar las disfunciones de movilidad de los tejidos del cuerpo humano que provocan trastornos y perturban el estado de salud del organismo. Pretende restablecer los equilibrios perturbados en todos los niveles funcionales del cuerpo humano restaurarndo las movilidades necesarias para la vida del en armonía.</p>
			</div>
		  </div>
		</div>
        ...
        ¿El tratamiento es doloroso?
		  ...
		  <div id="collapse1" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading1">
			<div class="panel-body px-3 mb-4">
			  <p>El tratamiento osteopático en el adulto no debe ser doloroso aunque hay técnicas que pueda resultar un poco incómodas.</p>
			</div>
		  </div>
		</div>
    ...
    <div class="panel panel-default">
        ...
        ¿Cuánto dura la sesión?
		  ...
		  <div id="collapse2" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading2">
			<div class="panel-body px-3 mb-4">
			  <p>Las sesiones tienen una durabilidad de 30 minutos o 1 hora de acuerdo a lo acordado con el paciente según sus patologías. </p>
			</div>
		  </div>
		</div>
