...
<!-- set a width on the image otherwise it will expand to full width       -->
      ...
      <a class="btn btn-lg " id="ctaButton" href="osteopatia.php" role="button">Conocé Más</a>
    </div>
    <!-- /.card -->
...
<!-- set a width on the image otherwise it will expand to full width       -->
      ...
      <a class="btn btn-lg " id="ctaButton" href="kinesiologia.php" role="button">Conocé Más</a>
    </div>
    <!-- /.card -->    
</div>
<!-- /.card-group -->
